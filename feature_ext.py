...
training_data_path = SCRIPT_DIR / "data/hackathon_public.json"
...
def get_circuit_details(training_data):
    circuit_details = {}
    circuit_info = {}
...
if __name__ == "__main__":
    training_data = parse_circuits()
    circuit_details = get_circuit_details(training_data)
